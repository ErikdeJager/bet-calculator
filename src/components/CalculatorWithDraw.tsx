...
const CalculatorWithDraw: Component = () => {
    ...
    const drawFrequency = createMemo(() => {
        const total = oneWinCount() + twoWinCount() + drawCount();
        return total > 0 ? drawCount() / total : 0;
    });
        ...
        <>
            ...
            <div class={"grid grid-cols-3 gap-14 mt-10"}>
                ...
                <div class={"flex flex-col gap-4"}>
                    ...
                    <div>
                        <p>Total draws</p>
                        <input type="number" class="input w-full" value={drawCount()} onInput={(e) => {
                    ...
                    <div>
                        <p>Odds of winning</p>
                        <input disabled type="text" step="any" placeholder="Format: 1,25" class="input w-full" value={drawFrequency() * 100 + "%"}/>
                    </div>
                </div>
...
export default CalculatorWithDraw;